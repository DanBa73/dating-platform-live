    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_fake', models.BooleanField(default=False, help_text='Designates whether this user is a fake profile managed internally.')),
                ('ai_personality_prompt', models.TextField(blank=True, help_text='Personality prompt for AI interactions (only used for fake users).', null=True)),
